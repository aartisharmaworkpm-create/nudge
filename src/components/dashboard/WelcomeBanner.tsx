...
export default function WelcomeBanner({ businessName }: { businessName: string }) {
  ...
  return (
    <div className="bg-teal-800 rounded-2xl px-6 py-5 mb-6 flex items-start justify-between gap-4">
      <div>
        ...
        <Link
          href="/invoices/new"
          className="inline-flex items-center gap-1.5 mt-3 bg-white text-teal-900 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-teal-50 transition-colors"
        >
      ...
      <button
        ...
        className="text-teal-200 hover:text-white flex-shrink-0 mt-0.5"
        aria-label="Dismiss"
      >
