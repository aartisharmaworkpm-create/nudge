              ...
              {sequence.status === "PAUSED" && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-amber-800 mb-0.5">Reminders paused</p>
                      {sequence.resumeAt ? (
                        <p className="text-xs text-amber-700">Resumes on {formatDate(sequence.resumeAt)}</p>
                      ) : (
                        <p className="text-xs text-amber-700">Paused until manually resumed</p>
                      )}
                      {sequence.pauseReason && (
                        <p className="text-xs text-amber-600 mt-1">Reason: {sequence.pauseReason}</p>
                      )}
                    </div>
                  </div>
                </div>
